...
func (s *websocketServiceTestSuite) TestDepthFeatureServe() {
	data := []byte(`{
        "e": "depthUpdate",
        "E": 1499404630606,
        "s": "ETHBTC",
	...
	doneC, stopC, err := WsDepthFeatureServe("ETHBTC", func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Event:         "depthUpdate",
			Time:          1499404630606,
			Symbol:        "ETHBTC",
...
func (s *websocketServiceTestSuite) TestDepth20FeatureServe() {
	data := []byte(`{
        "e": "depthUpdate",
        "E": 1499404630606,
        "s": "ETHBTC",
	...
	doneC, stopC, err := WsDepth20FeatureServe("ETHBTC", func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Event:         "depthUpdate",
			Time:          1499404630606,
			Symbol:        "ETHBTC",
...
func (s *websocketServiceTestSuite) TestDepth20SpotServe() {
	data := []byte(`{
        "e": "depthUpdate",
        "E": 1499404630606,
        "s": "ETHBTC",
	...
	doneC, stopC, err := WsDepth20SpotServe("ETHBTC", func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Event:         "depthUpdate",
			Time:          1499404630606,
			Symbol:        "ETHBTC",
...
func (s *websocketServiceTestSuite) TestDepthSpotServe() {
	data := []byte(`{
        "e": "depthUpdate",
        "E": 1499404630606,
        "s": "ETHBTC",
	...
	doneC, stopC, err := WsDepthSpotServe("ETHBTC", func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Event:         "depthUpdate",
			Time:          1499404630606,
			Symbol:        "ETHBTC",
...
func (s *websocketServiceTestSuite) TestKlineServe() {
	...
	doneC, stopC, err := WsKlineSpotServe("ETHBTC", "1m", func(event *WsKlineEvent) {
		e := &WsKlineEvent{
			Event:  "kline",
			Time:   1499404907056,
			Symbol: "ETHBTC",
...
func (s *websocketServiceTestSuite) TestKlineFeatureServe() {
	data := []byte(`{
        "e": "kline",
        "E": 1499404907056,
        "s": "ETHBTC",
	...
	doneC, stopC, err := WsKlineFeatureServe("ETHBTC", "1m", func(event *WsKlineEvent) {
		e := &WsKlineEvent{
			Event:  "kline",
			Time:   1499404907056,
			Symbol: "ETHBTC",
...
func (s *websocketServiceTestSuite) TestWsFuturesMarketStatServe() {
	data := []byte(`{
  		"e": "24hrTicker",
  		"E": 123456789,
  		"s": "BTCUSDT_PERP",
	...
	doneC, stopC, err := WsFuturesMarketStatServe("BTCUSDT_PERP", func(event *WsMarketStatEvent) {
		e := &WsMarketStatEvent{
			Event:              "24hrTicker",
			Time:               123456789,
			Symbol:             "BTCUSDT_PERP",
...
func (s *websocketServiceTestSuite) TestWsFuturesCoinMarketStatServe() {
	data := []byte(`{
  		"e": "24hrTicker",
  		"E": 123456789,
  		"s": "DOTUSDT_PERP",
	...
	doneC, stopC, err := WsFuturesCoinMarketStatServe("DOTUSDT_PERP", func(event *WsMarketStatEvent) {
		e := &WsMarketStatEvent{
			Event:              "24hrTicker",
			Time:               123456789,
			Symbol:             "DOTUSDT_PERP",
...
func (s *websocketServiceTestSuite) TestWsTradeFutureServe() {
	data := []byte(`{
        "e": "trade",
        "E": 123456789,
        "s": "BNBBTC",
	...
	doneC, stopC, err := WsTradeFutureServe("BNBBTC", func(event *WsTradeEvent) {
		e := &WsTradeEvent{
			Event:         "trade",
			Time:          123456789,
			Symbol:        "BNBBTC",
