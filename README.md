...
```shell
go get github.com/shaolinjehzu/go-binance
```
...
[![GoDoc](https://godoc.org/github.com/shaolinjehzu/go-binance?status.svg)](https://godoc.org/github.com/shaolinjehzu/go-binance)
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/shaolinjehzu/go-binance) for full references.
